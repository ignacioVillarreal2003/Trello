...
public class TaskServiceTests
{
    ...
    public TaskServiceTests()
    {
        ...
        _service = new TaskService(_mockMapper.Object, _mockBoardAuthorizationService.Object, _mockLogger.Object, _mockTaskRepository.Object);
    }
    ...
    public async Task GetTaskById_ReturnsOutputTaskDto_WhenTaskExists()
    {
        ...
        var task = new Domain.Task.Task(title: "Task 1", description: "", listId: 1, priority: "Medium") { Id = taskId };
    ...
    public async Task GetTaskById_ReturnsNull_WhenTaskDoesNotExist()
    {
        ...
        _mockTaskRepository.Setup(r => r.GetTaskById(taskId)).ReturnsAsync((Domain.Task.Task?)null);
    ...
    public async Task GetTasksByListId_ReturnsListOfOutputTaskDto_WhenTasksExist()
    {
        ...
        {
            new Domain.Task.Task(title: "Task 1", description: "", listId: listId, priority: "Medium") { Id = 1 },
            new Domain.Task.Task(title: "Task 2", description: "", listId: listId, priority: "Medium") { Id = 2 }
        };
    ...
    public async Task GetTasksByListId_ReturnsEmptyList_WhenNoTasksExist()
    {
        ...
        _mockTaskRepository.Setup(r => r.GetTasksByListId(listId)).ReturnsAsync(new List<Domain.Task.Task>());
        _mockMapper.Setup(m => m.Map<List<OutputTaskDto>>(It.IsAny<List<Domain.Task.Task>>())).Returns(new List<OutputTaskDto>());
    ...
    public async Task AddTask_ReturnsOutputTaskDto_WhenTaskIsAdded()
    {
        ...
        var newTask = new Domain.Task.Task(title: addTaskDto.Title, listId: listId, description: addTaskDto.Description) { Id = 1 };
        ...
        _mockTaskRepository.Setup(r => r.AddTask(It.IsAny<Domain.Task.Task>())).ReturnsAsync(newTask);
    ...
    public async Task AddTask_ReturnsNull_WhenRepositoryReturnsNull()
    {
        ...
        _mockTaskRepository.Setup(r => r.AddTask(It.IsAny<Domain.Task.Task>())).ReturnsAsync((Domain.Task.Task?)null);
    ...
    {
        int taskId = 1, userId = 1;
        var existingTask = new Domain.Task.Task(title: "Old Title", description: "", listId: 1) { Id = taskId };
        var updateTaskDto = new UpdateTaskDto { Title = "New Title" };
        var updatedTask = new Domain.Task.Task(title: updateTaskDto.Title, listId: existingTask.ListId, description: existingTask.Description) { Id = existingTask.Id };
    ...
    public async Task UpdateTask_ReturnsNull_WhenUpdateFails()
    {
        ...
        _mockTaskRepository.Setup(r => r.GetTaskById(taskId)).ReturnsAsync(existingTask);
        _mockTaskRepository.Setup(r => r.UpdateTask(existingTask)).ReturnsAsync((Domain.Task.Task?)null);
    ...
    public async Task DeleteTask_ReturnsNull_WhenDeletionFails()
    {
        ...
        _mockTaskRepository.Setup(r => r.GetTaskById(taskId)).ReturnsAsync(existingTask);
        _mockTaskRepository.Setup(r => r.DeleteTask(existingTask)).ReturnsAsync((Domain.Task.Task?)null);
