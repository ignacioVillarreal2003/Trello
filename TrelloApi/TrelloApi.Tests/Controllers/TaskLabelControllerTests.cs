...
public class TaskLabelControllerTests
{
    private readonly Mock<ITaskLabelService> _mockTaskLabelService;
    private readonly Mock<ILogger<TaskLabelController>> _mockLogger;
    private readonly TaskLabelController _controller;

    public TaskLabelControllerTests()
    {
        _mockTaskLabelService = new Mock<ITaskLabelService>();
        _mockLogger = new Mock<ILogger<TaskLabelController>>();

        _controller = new TaskLabelController(_mockLogger.Object, _mockTaskLabelService.Object);
        SetUserId(1);
    }
