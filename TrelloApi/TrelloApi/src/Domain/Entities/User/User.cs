...
public class User
{
    ...
    public ICollection<UserTask.UserTask> UserTasks { get; set; } = new HashSet<UserTask.UserTask>();
    
    public ICollection<Domain.Comment.Comment> Comments { get; set; } = new HashSet<Domain.Comment.Comment>();
